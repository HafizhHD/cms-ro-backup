...
import './CMSActivityLog.scss';
import { getUserList, getCMSActivityLog, getSchoolGroupList } from '../../../../components/API/filter.js'
...
const CMSActivityLog = () => {
    ...
    return (
        ...
        <div className="CMSLog">
            <Heading
                headingName="Log Aktivitas CMS"
                routes={[
                    { name: 'Report', path: '/report/cms-activity-log' },
                    { name: 'Log Aktivitas CMS' }
                ]}
            />
